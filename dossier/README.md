...
**👉 https://raw.githack.com/skytechnext/JRtechsky/claude/wizardly-mayer-ocjx0y/index.html**
...
The root `index.html` redirects to `site/index.html`. Your URL will be
`https://skytechnext.github.io/JRtechsky/`.

## Structure
- `site/` — the static dossier (no build step): `index.html`, `assets/` (design system + shared
...
## View locally
Open `index.html` in a browser, or `cd site && python3 -m http.server` then visit
`http://localhost:8000`.
